-- VelocityMall Flyway initial schema.
-- This migration is non-destructive: it creates the current schema for a clean database
-- and never drops existing business tables.
ALTER DATABASE `velocity_mall`
